    ...
    <div className="container mb-10">
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-8">
          ...
          <div>
            ...
            <h1 className="text-md font-medium">
              <span className="font-bold">Location:</span> {blogDetail.location}
            </h1>
            <h1 className="text-md font-medium">
              <span className="font-bold">category:</span> {blogDetail.category}
            </h1>
            <h1 className="text-md font-medium">
              <span className="font-bold">Travelling expense: </span>$
              {blogDetail.cost}
            </h1>
          </div>
          <div className="mt-5">
        ...
        <div className="col-span-4">
          <h1 className="text-2xl text-center font-bold">More blogs</h1>
          <h4 className="text-lg text-center font-medium mt-10">Coming Soon</h4>
        </div>
      </div>
    </div>
  );
